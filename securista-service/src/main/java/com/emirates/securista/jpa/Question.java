...
public class Question implements Serializable {
	...
	public Question(long questionId, String question, String answerOpt, String clue, int numOfOptions,
	...
	public static Question getDummyQ(int id, int levelCode) {
		long questionId = id;
		...
		if (levelCode == 2) {
			optionsToSkipFr5050 = "2";
		} else if (levelCode == 3) {
			optionsToSkipFr5050 = "1,6";
		}

		Question dto = new Question(questionId, question, answerOpt, clue, numOfOptions, correctOptionsCount,
